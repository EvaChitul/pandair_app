...
class AircraftCreation(unittest.TestCase):
    ...
    def test_private_aircraft_creation(self):
        ...
        private_check = pandair_application_final.PrivateAircraft(*arguments)
        assert isinstance(private_check, pandair_application_final.PrivateAircraft), 'Did not create PrivateAircraft'

    def test_commercial_aircraft_creation(self):

        details = ['Airbus', 300, 400, 200, 'C000', 20, 500]
        commercial_check = pandair_application_final.CommercialAircraft(*details)
        assert isinstance(commercial_check, pandair_application_final.CommercialAircraft), 'Did not create CommercialAircraft'

    def test_cargo_aircraft_creation(self):

        data = ['Bombardier', 200, 300, 250, 'CA00', 300, 20]
        cargo_check = pandair_application_final.CargoAircraft(*data)
        assert isinstance(cargo_check, pandair_application_final.CargoAircraft), 'Did not create CargoAircraft'
...
class AircraftMethods(unittest.TestCase):
    ...
    def test_due_for_maintenance_method_returns_true_over_30(self):
        ...
        maintenance_check = pandair_application_final.Aircraft(*check).due_for_maintenance()
    ...
    def test_due_for_maintenance_method_returns_false_under_30(self):
        ...
        maintenance_check_2 = pandair_application_final.Aircraft(*check_2).due_for_maintenance()
    ...
    def test_quick_maintenance_method_cargo_set_to_zero_if_negative(self):
        ...
        maintenance_aircraft = pandair_application_final.CargoAircraft(*check_3)
    ...
    def test_quick_maintenance_method_private_decreases_by_10_if_positive(self):
        ...
        main_aircraft = pandair_application_final.PrivateAircraft(*check_4)
...
class AirportChecks(unittest.TestCase):
    ...
    def test_airport_is_created_as_list(self):
        airport = pandair_application_final.Airport()
    ...
    def test_add_aircraft_to_airport_method(self):
        ...
        aircraft = pandair_application_final.PrivateAircraft(*check)
        airport_2 = pandair_application_final.Airport()
    ...
    def test_add_aircraft_that_already_exists_to_airport(self):
        ...
        aircraft = pandair_application_final.CargoAircraft(*check)
        airport = pandair_application_final.Airport()
    ...
    def test_remove_aircraft_from_airport_method(self):
        ...
        aircraft_1 = pandair_application_final.PrivateAircraft(*check_1)
        airport_3 = pandair_application_final.Airport()
    ...
    def test_remove_aircraft_that_does_not_exist_at_airport(self):
        ...
        aircraft_3 = pandair_application_final.PrivateAircraft(*check_3)
        aircraft_4 = pandair_application_final.CargoAircraft(*check_4)
        airport_3 = pandair_application_final.Airport()
    ...
    def test_operator_overload_adds_two_airports(self):
        info_1 = ['Airbus', 100, 200, 150, 'TEST100', 20, 300]
        info_2 = ['Bombardier', 100, 200, 150, 'TEST200', 50, 300]
        plane_1 = pandair_application_final.PassengerAircraft(*info_1)
        plane_2 = pandair_application_final.CommercialAircraft(*info_2)

        airport_1 = pandair_application_final.Airport()
        airport_2 = pandair_application_final.Airport()

        airport_1.add_aircraft(plane_1)
        airport_2.add_aircraft(plane_2)

        self.assertEqual(2, len(airport_1+airport_2)), 'Function to add airports via operator overloading not adding two airports'


class FleetChecks(unittest.TestCase):

    def test_fleet_is_created_as_dictionary(self):
        fleet_test = pandair_application_final.FleetDatabase()
        assert isinstance(fleet_test.fleet, dict), 'Fleet is not a dictionary'

    def test_fleet_len_method(self):
        fleet_len = pandair_application_final.FleetDatabase()
    ...
    def test_add_airport_with_aircraft_to_fleet(self):
        ...
        aircraft = pandair_application_final.CommercialAircraft(*check_plane)
        check_airport = pandair_application_final.Airport()
        check_airport.add_aircraft(aircraft)
        fleet_check = pandair_application_final.FleetDatabase()
    ...
    def test_remove_airport_from_fleet(self):
        ...
        plane = pandair_application_final.CommercialAircraft(*plane_info)
        airport = pandair_application_final.Airport()
        airport.add_aircraft(plane)
        fleet_check_1 = pandair_application_final.FleetDatabase()
    ...
    def test_get_item_creates_airport_if_airport_does_not_exist_in_fleet(self):
        empty_fleet = pandair_application_final.FleetDatabase()
...
class CheckOperateFlight(unittest.TestCase):
    ...
    def test_operate_flight_moves_plane_from_origin_to_destination(self):
        ...
        new_plane = pandair_application_final.CommercialAircraft(*plane_info)

        origin_airport = pandair_application_final.Airport()
        destination_airport = pandair_application_final.Airport()
        origin_airport.add_aircraft(new_plane)

        new_fleet = pandair_application_final.FleetDatabase()
        ...
        pandair_application_final.operate_flight(new_fleet, 'origin airport name', 'destination airport name', new_plane)
    ...
    def test_operate_flight_increases_aircraft_maintenance_number_by_1(self):
        ...
        new_plane = pandair_application_final.CommercialAircraft(*new_plane_info)
        ...
        pandair_application_final.operate_flight(new_fleet, 'origin name', 'destination name', new_plane)
...
class CheckGeneratePairs(unittest.TestCase):
    ...
    def test_generator_gives_expected_number_of_origin_destination_pairs(self):
        ...
        plane_1 = pandair_application_final.CommercialAircraft(*plane_info_1)
        plane_2 = pandair_application_final.CommercialAircraft(*plane_info_2)

        airport_1 = pandair_application_final.Airport()
        airport_2 = pandair_application_final.Airport()
        airport_3 = pandair_application_final.Airport()
        airport_4 = pandair_application_final.Airport()
        ...
        list_pairs = []
        check = pandair_application_final.generate_pairs(fleet_check)
        for pair in pandair_application_final.generate_pairs(fleet_check):
            list_pairs.append(next(check))

        self.assertEqual(6, len(list_pairs)), 'Generator not giving the expected origin-destination paris'


class CheckAlterAircraftContextManager(unittest.TestCase):

    def test_alter_aircraft_context_manager_changes_due_for_maintenance_method_to_return_false(self):
